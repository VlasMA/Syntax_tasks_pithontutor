...
# Программа получает на вход список, затем число k. Программа сдвигает все элементы, а после этого удаляет последний элемент списка
...
for i in range(k + 1, len(a)):
    a[i-1] = a[i]
a.pop()    # если в скобках ничего нет, то удалит последний элемент списка. По факту мы сдвинули все элементы от числа К - которое стало последним в списке
